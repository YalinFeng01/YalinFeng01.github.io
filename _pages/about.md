...
My primary research goal is to enhance visual consistency and production quality in digital art and animation using state-of-the-art AI. Currently, I am exploring how to optimize the SDXL VAE latent space using geometry-guided sparse correspondence and cross-view attention.

I am actively seeking **PhD opportunities** or **Research Assistant (RA)** positions for the upcoming application cycle. 
...
* **[Aug 2025]** Joined the Data-Centric AI (DCAI) Lab at **Peking University** as a Research Assistant, supervised by Prof. Wentao Zhang.
* **[Jul 2025]** Started my journey as a remote Research Assistant by contributing to my first major open-source project, *DataFlow*.

Research Interests
======
* **Generative Models:** Diffusion Models, Flow Matching, Latent Diffusion
* **Pose Generation:** Sign Language Generation & Control
* **Multimodal Large Language Models (MLLM):** Multimodal Understanding and Generation
